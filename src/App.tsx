  ...
  return <div className="background" style={{backgroundColor:randomColor}}>
    <div id="quote-box">
      ...
      <div className="buttons">
        ...
        id='tweet-quote' style={{backgroundColor:"#1DA1F2",marginRight:"10px"}}><FaTwitter color='white'></FaTwitter></a>
        <button id="new-quote" onClick={changeQuote} style={{color:"white"}}>Change Quote</button>
      </div>
    </div>
  </div>
}
